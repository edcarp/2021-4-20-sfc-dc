...
instructor: ["Nadine Bestard-Cuche", "Peter Smyth", "Mario Antonioletti"] # boxed, comma-separated list of instructors' names as strings, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
helper: ["Robert Nagy", "Steven Ford", "Sam Haynes", "Mike Spencer", "Andrzej Romaniuk", "Lucie Woellenstein", "Donncha Dunican"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2021-04-20-sfc-dc # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
eventbrite: 142394035393          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
